...
describe('Component Tests', () => {
  describe('DemandeOffre Management Component', () => {
    let comp: DemandeOffreComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DemandeOffreComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.demandeOffres[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
